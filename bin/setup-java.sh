...
curl -L https://dlcdn.apache.org/maven/maven-3/3.8.3/binaries/apache-maven-3.8.3-bin.tar.gz | gzip -dc | tar -C $HOME/lang/java -xf -
curl -L https://services.gradle.org/distributions/gradle-7.3-bin.zip > $HOME/tmp/gradle-bin.zip
